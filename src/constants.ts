...
export const MOCK_KANBAN_COLUMNS: KanbanColumn[] = [
  ...
  { id: 'qualification', title: 'Qualificação', color: 'border-cyan-500' },
  { id: 'presentation', title: 'Apresentação', color: 'border-violet-500' },
  { id: 'negotiation', title: 'Negociação', color: 'border-orange-500' },
  { id: 'won', title: 'Fechado / Ganho', color: 'border-emerald-500' },
];
