-- Higienize match_chunks: consistent lower() normalization, bai_norm trim,
-- cheap filters before vector similarity. Business logic unchanged.
      ...
      and (
        ...
        or (
          ...
          and (
            ...
            or lower(c.meta->>'cidade') like '%' || lower(mun_norm) || '%'
            or lower(mun_norm) like '%' || lower(c.meta->>'cidade') || '%'
          )
        )
